...
import com.kaleyra.video.conversation.Message.Content.Text
import com.kaleyra.video.conversation.Message.State.Received
...
class ChatNotificationActionReceiver : KaleyraVideoBroadcastReceiver() {
     ...
     */
    companion object {
        const val ACTION_REPLY = "com.kaleyra.video_common_ui.REPLY"
        const val ACTION_MARK_AS_READ = "com.kaleyra.video_common_ui.MARK_AS_READ"
    }
