...
import com.kaleyra.video_sdk.Mocks.now
...
import com.kaleyra.video_sdk.Mocks.yesterday
...
import com.kaleyra.video_sdk.chat.mapper.MessagesMapper.mapToUiState
import com.kaleyra.video_sdk.chat.mapper.MessagesMapper.toUiMessage
...
class MessagesMapperTest {
    ...
    fun otherMessage_toUiState_mappedOtherMessage() = runTest {
        ...
        val expected =
            com.kaleyra.video_sdk.chat.conversation.model.Message.OtherMessage(
    ...
    fun myMessage_toUiState_mappedMyMessage() = runTest {
        ...
        val expected =
            com.kaleyra.video_sdk.chat.conversation.model.Message.MyMessage(
                message.id,
        ...
        val result = message.toUiMessage() as com.kaleyra.video_sdk.chat.conversation.model.Message.MyMessage
    ...
    private suspend fun isSameMessageItem(
        ...
        if (message1 !is com.kaleyra.video_sdk.chat.conversation.model.Message.MyMessage) return false
        if (message2 !is com.kaleyra.video_sdk.chat.conversation.model.Message.MyMessage) return false
