...
package com.bandyer.video_android_phone_ui.call.buttons

import android.content.Context
import android.util.AttributeSet
import android.view.LayoutInflater
import android.widget.LinearLayout
import com.bandyer.video_android_phone_ui.databinding.BandyerActionButtonAudiorouteBinding
import com.google.android.material.button.MaterialButton
import com.google.android.material.textview.MaterialTextView

/**
 * Bandyer Action Button which custom layout for the audio route button
 */
class BandyerAudioRouteActionButton @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private val binding: BandyerActionButtonAudiorouteBinding by lazy { BandyerActionButtonAudiorouteBinding.inflate(LayoutInflater.from(context), this) }
