 ...
 */
class BandyerCallInfoWidget @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = R.attr.bandyer_rootLayoutStyle)
    ...
    private val binding: BandyerWidgetCallInfoBinding by lazy { BandyerWidgetCallInfoBinding.inflate(LayoutInflater.from(context), this) }

    init {
        titleView = binding.bandyerTitle
        subtitleView = binding.bandyerSubtitle
        recordingView = binding.bandyerRecording

        titleView?.isSelected = true // activate marquee
        watermarkView = binding.bandyerWatermark
