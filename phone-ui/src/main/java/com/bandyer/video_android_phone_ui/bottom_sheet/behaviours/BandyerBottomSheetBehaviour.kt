...
package com.bandyer.video_android_phone_ui.bottom_sheet.behaviours
...
class BandyerBottomSheetBehaviour<V : View>(context: Context, attrs: AttributeSet?) : CoordinatorLayout.Behavior<V>(context, attrs) {
    ...
    init {
        ...
        a.recycle()
        a = context.obtainStyledAttributes(attrs, R.styleable.BandyerSDKDesign_BottomSheet_Behavior)
        if (attrs != null) {
            mAnchorPoint = a.getDimension(R.styleable.BandyerSDKDesign_BottomSheet_Behavior_bandyer_anchorPoint, -1f).toInt()
            skipAnchor = mAnchorPoint < 0
            mState = a.getInt(R.styleable.BandyerSDKDesign_BottomSheet_Behavior_bandyer_defaultStatus, STATE_COLLAPSED)
        }
        a.recycle()
    ...
    companion object {
        ...
        /**
         * A utility function to get the [BandyerBottomSheetBehaviour] associated with the `view`.
         *
         * @param view The [View] with [BandyerBottomSheetBehaviour].
         * @param <V>  Instance of behavior
         * @return The [BandyerBottomSheetBehaviour] associated with the `view`.
         */
