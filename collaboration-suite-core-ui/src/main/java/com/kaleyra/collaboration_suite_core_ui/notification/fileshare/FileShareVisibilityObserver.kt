...
class FileShareVisibilityObserver internal constructor(): BroadcastReceiver() {
     ...
     */
    companion object {
        const val ACTION_FILE_SHARE_DISPLAYED = "com.kaleyra.collaboration_suite_core_ui.FILE_SHARE_DISPLAYED"

        const val ACTION_FILE_SHARE_NOT_DISPLAYED = "com.kaleyra.collaboration_suite_core_ui.FILE_SHARE_NOT_DISPLAYED"
