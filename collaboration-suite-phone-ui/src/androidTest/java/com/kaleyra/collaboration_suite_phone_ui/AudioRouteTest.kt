...
class AudioRouteTest {
    ...
    fun bluetoothDeviceWithNoName_genericBluetoothItemDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, null, BluetoothDeviceState.ACTIVE, 30)))
    ...
    fun bluetoothDeviceWithName_bluetoothItemDisplayedAsTheDeviceName() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.ACTIVE, 30)))
    ...
    fun bluetoothDeviceBatteryLevel_bluetoothItemBatteryPercentageDisplayed() {
        ...
        val batteryInfo = composeTestRule.activity.getString(R.string.kaleyra_bluetooth_battery_info, batteryLevel, 30)
    ...
    fun bluetoothDeviceDisconnected_deviceStateDisconnectedDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.DISCONNECTED, 30)))
    ...
    fun bluetoothDeviceFailed_deviceStateFailedDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.FAILED, 30)))
    ...
    fun bluetoothDeviceAvailable_deviceStateAvailableDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.AVAILABLE, 30)))
    ...
    fun bluetoothDeviceDeactivating_deviceStateDeactivatingDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.DEACTIVATING, 30)))
    ...
    fun bluetoothDeviceConnected_deviceStateConnectedDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.CONNECTED, 30)))
        val connected = composeTestRule.activity.getString(R.string.kaleyra_call_action_audio_route_bluetooth_connected)
        composeTestRule.onNode(hasText(text = connected, substring = true)).assertIsDisplayed()
    }
    ...
    fun bluetoothDeviceActivating_deviceStateConnectedDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.ACTIVATING, 30)))
        val connected = composeTestRule.activity.getString(R.string.kaleyra_call_action_audio_route_bluetooth_connected)
        composeTestRule.onNode(hasText(text = connected, substring = true)).assertIsDisplayed()
    }
    ...
    fun bluetoothDeviceActivating_connectingStateActivatingDisplayed() {
        ...
        val statusInfo = composeTestRule.activity.getString(R.string.kaleyra_bluetooth_connecting_status_info, activating)
    ...
    fun bluetoothDeviceConnecting_connectingStateActivatingDisplayed() {
        items = ImmutableList(listOf(AudioDevice.Bluetooth("", false, "customBluetooth", BluetoothDeviceState.CONNECTING, 30)))
        val activating = composeTestRule.activity.getString(R.string.kaleyra_call_action_audio_route_bluetooth_activating)
        val statusInfo = composeTestRule.activity.getString(R.string.kaleyra_bluetooth_connecting_status_info, activating)
