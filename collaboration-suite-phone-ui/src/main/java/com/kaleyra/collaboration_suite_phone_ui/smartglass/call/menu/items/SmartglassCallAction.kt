 ...
 * @constructor
 */
open class SMART_GLASS_CAMERA(mToggled: Boolean, private val ctx: Context): CallAction.TogglableCallAction(R.id.kaleyra_id_camera, mToggled, R.layout.kaleyra_smartglass_call_action_item, ctx.getSmartGlassMenuAttribute(R.styleable.KaleyraCollaborationSuiteUI_SmartGlassMenu_kaleyra_smartGlassCameraStyle)) {
 ...
 * @constructor
 */
open class SMART_GLASS_MICROPHONE(mToggled: Boolean, private val ctx: Context): CallAction.TogglableCallAction(R.id.kaleyra_id_microphone, mToggled, R.layout.kaleyra_smartglass_call_action_item, ctx.getSmartGlassMenuAttribute(R.styleable.KaleyraCollaborationSuiteUI_SmartGlassMenu_kaleyra_smartGlassMicrophoneStyle)) {
 ...
 * @constructor
 */
open class SMART_GLASS_PARTICIPANTS(ctx: Context): CallAction(R.id.kaleyra_id_participants, R.layout.kaleyra_smartglass_call_action_item, ctx.getSmartGlassMenuAttribute(R.styleable.KaleyraCollaborationSuiteUI_SmartGlassMenu_kaleyra_smartGlassParticipantsStyle))
