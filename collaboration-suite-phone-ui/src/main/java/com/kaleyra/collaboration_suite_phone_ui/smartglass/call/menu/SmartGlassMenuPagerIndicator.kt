...
import com.kaleyra.collaboration_suite_phone_ui.extensions.getPagerIndicatorBooleanAttribute
import com.kaleyra.collaboration_suite_phone_ui.extensions.getPagerIndicatorColorAttribute
import com.kaleyra.collaboration_suite_phone_ui.extensions.getPagerIndicatorDimensionPixelSizeAttribute
import com.kaleyra.collaboration_suite_phone_ui.extensions.getPagerIndicatorIntAttribute
...
class SmartGlassMenuPagerIndicator @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : View(context, attrs, defStyle), ViewPager.OnPageChangeListener {
    ...
    @ColorInt
    private var dotColor: Int = ContextCompat.getColor(context, R.color.kaleyra_colorOnSurface)

    @ColorInt
    private var selectedDotColor: Int = ContextCompat.getColor(context, R.color.kaleyra_colorPrimary)
