...
package com.kaleyra.collaboration_suite_phone_ui.call.imageviews
...
/**
 * Kaleyra avatar image view
 * @property type if single user or multiple placeholder
 * @constructor
 */
class KaleyraAvatarImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ShapeableImageView(context, attrs, defStyleAttr) {
    ...
    enum class Type(val value: IntArray) {
         ...
         * single user
         */
        USER(intArrayOf(R.attr.kaleyra_state_user)),

        /**
         * multiple users
         */
        MULTIPLE_USERS(intArrayOf(R.attr.kaleyra_state_multiple_users))
    }
}