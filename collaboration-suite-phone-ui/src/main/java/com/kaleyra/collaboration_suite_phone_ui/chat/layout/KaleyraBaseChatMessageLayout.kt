 ...
 * @constructor
 */
abstract class KaleyraBaseChatMessageLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ConstraintLayout(context, attrs, defStyleAttr) {
     ...
     */
    var statusView: KaleyraChatMessageStatusImageView? = null
        private set
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.kaleyra_chat_message_base, this, true)
        this.id = R.id.kaleyra_id_base_chat_message_layout
        this.layoutParams = ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)

        dataViewContainer = findViewById(R.id.kaleyra_data_view_container)
        statusView = findViewById(R.id.kaleyra_status_view)
        timestampTextView = findViewById(R.id.kaleyra_timestamp_view)
        dataView = findViewById(R.id.kaleyra_data_view)
    }
