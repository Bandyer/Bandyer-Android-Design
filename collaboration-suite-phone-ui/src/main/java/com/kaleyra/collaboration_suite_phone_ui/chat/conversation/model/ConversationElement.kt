...
sealed class ConversationElement(val id: String) {
    ...
    data class Message(val message: com.kaleyra.collaboration_suite_phone_ui.chat.conversation.model.Message, val isMessageGroupClosed: Boolean = false) : ConversationElement(id = message.id)
}