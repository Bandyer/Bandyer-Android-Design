...
sealed class ConversationElement(val id: String) {
    ...
    data class Message(val message: com.kaleyra.collaboration_suite_phone_ui.chat.conversation.model.Message, val isFirstChainMessage: Boolean = true, val isLastChainMessage: Boolean = true) : ConversationElement(id = message.id)
}