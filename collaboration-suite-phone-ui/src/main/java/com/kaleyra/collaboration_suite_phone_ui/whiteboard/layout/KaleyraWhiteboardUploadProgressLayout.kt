...
import com.kaleyra.collaboration_suite_phone_ui.databinding.KaleyraProgressViewLayoutBinding
...
/**
 *
 * @property state KaleyraWhiteboardUploadProgressLayout.State?
 ...
 * @constructor
 */
class KaleyraWhiteboardUploadProgressLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = R.attr.kaleyra_rootLayoutStyle) : MaterialCardView(context, attrs, defStyleAttr) {
    ...
    private val binding: KaleyraProgressViewLayoutBinding by lazy { KaleyraProgressViewLayoutBinding.inflate(LayoutInflater.from(context), this) }

    init {
        progressTitle = binding.kaleyraWhiteboardProgressTitle
        progressSubtitle = binding.kaleyraWhiteboardProgressSubtitle
        progressText = binding.kaleyraWhiteboardProgressProgressText
        progressBar = binding.kaleyraWhiteboardProgressProgressBar
        errorImage = binding.kaleyraWhiteboardProgressErrorImage
    ...
    fun updateUploadingProgress(percentage: Int) {
        ...
        progressText?.text = resources.getString(R.string.kaleyra_file_upload_percentage, percentage)
    }
    ...
    /**
     * States of a KaleyraWhiteboardUploadProgressLayout
     * @constructor
     */
    enum class State {
        /**
