...
class UiModelMapperTest {
    ...
    @Test
    fun chatBoxUserInactiveState_getChatState_none() = runTest {
        chatBoxState.value = ChatBox.State.Disconnected.UserInactive
        assertEquals(getChatState(flowOf(chatParticipantsMock), flowOf(chatBoxMock)).first(), ChatState.None)
    }

    @Test
    fun chatBoxUnsupportedVersionState_getChatState_none() = runTest {
        chatBoxState.value = ChatBox.State.Disconnected.UnsupportedVersion
        assertEquals(getChatState(flowOf(chatParticipantsMock), flowOf(chatBoxMock)).first(), ChatState.None)
    }

    @Test
    fun chatBoxUnknownState_getChatState_none() = runTest {
    ...
    @Test
    fun chatBoxConnectedAndParticipantOnline_getChatState_userOnline() = runTest {
        chatBoxState.value = ChatBox.State.Connected
    ...
    @Test
    fun chatBoxConnectedAndParticipantOfflineAt_getChatState_userOfflineTimestamp() = runTest {
        chatBoxState.value = ChatBox.State.Connected
    ...
    @Test
    fun chatBoxConnectedAndParticipantOffline_getChatState_userOffline() = runTest {
        chatBoxState.value = ChatBox.State.Connected
    ...
    @Test
    fun chatBoxConnectedAndParticipantTyping_getChatState_userTyping() = runTest {
        chatBoxState.value = ChatBox.State.Connected
    ...
    fun allMessagesRead_findFirstUnreadMessage_null() = runTest {
        ...
        val fetch = { _: Int -> Result.success(messages) }
