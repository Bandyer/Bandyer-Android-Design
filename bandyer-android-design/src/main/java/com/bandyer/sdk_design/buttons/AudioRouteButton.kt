...
class AudioRouteButton @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : MaterialButton(context, attrs, defStyleAttr) {
    ...
    enum class State(val value: IntArray) {
         ...
         */
        BLUETOOTH(intArrayOf(R.attr.bandyer_state_bluetooth)),
         ...
         */
        LOUDSPEAKER(intArrayOf(R.attr.bandyer_state_loudspeaker)),
         ...
         */
        WIRED_HEADSET(intArrayOf(R.attr.bandyer_state_wired_headset)),
         ...
         */
        EARPIECE(intArrayOf(R.attr.bandyer_state_earpiece)),
         ...
         */
        MUTED(intArrayOf(R.attr.bandyer_state_muted))
    }
}
